...
import com.lr.construcao.management.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    @Value("${cors.originPatterns:http://localhost:8080,http://localhost:5173,https://lr-construcao.onrender.com}")
